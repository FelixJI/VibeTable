...
internal static class ProductDataRpcRegistry
{
    ...
    [
        ...
        new("version.create", p => Safe(p) && HasStrings(p, "collection", "itemId", "operationId"),
            ...
            MutatesWorkspace: true),
        new("version.save", p => Safe(p) && HasStrings(p, "collection", "itemId", "versionId", "operationId", "expectedRevision") && HasObject(p, "values"),
        ...
        new("version.promote", p => Safe(p) && HasStrings(p, "collection", "itemId", "versionId", "mainHash", "operationId", "expectedRevision"),
