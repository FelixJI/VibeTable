    ...
    public void GeneratedManifestProvidesClosedRouteLookupForCurrentOwners()
    {
        ...
        CollectionAssert.AreEqual(
            new[]
            {
                ...
                "field.change.apply:workspace",
                "field.change.cancel:workspace",
                "field.change.plan:workspace",
                "field.change.status:workspace",
                ...
                "insights.dashboardQueryLimits:workspace",
                "insights.deleteDashboardWorkspace:workspace",
                "insights.executeDashboardQuery:workspace",
                "insights.listDashboards:workspace",
                "insights.panelManifest:workspace",
                "insights.readDashboardWorkspace:workspace",
                "insights.saveDashboardDraft:workspace",
                ...
                "plugin.listAudit:workspace",
                "plugin.listCatalog:workspace",
                "plugin.listPendingCleanup:workspace",
                "plugin.setEnabled:workspace",
                "preset.delete:workspace",
                "preset.list:workspace",
                "preset.save:workspace",
                ...
                "relation.applyDelta:workspace",
                "relation.createTarget:workspace",
                "relation.inspectPair:workspace",
                "relation.previewDelta:workspace",
                "relation.searchTargets:workspace",
                "relation.updateSingle:workspace",
                "schema.delete:workspace",
                ...
                "version.list:workspace",
                "version.promote:workspace",
                "version.save:workspace",
            },
            manifest.GetProductSidecarRegistrations()
