...
public sealed class ProductRpcRouteSelectorTests
{
    ...
    public void GeneratedPolicySelectsCurrentOwners()
    {
        ...
        foreach (string method in ProductDataRpcRegistry.RequestTypes)
        {
            ...
            Assert.AreEqual(method is "settings.readWorkCalendar" or "settings.commitWorkCalendar" or "contentProfile.commit" or "contentProfile.delete" or "contentProfile.load" or "recordDocumentLink.commit" or "recordDocumentLink.delete" or "recordDocumentLink.list" or "recordDocumentLink.repair" or "relation.inspectPair" or "events.reconcile" or "field.change.apply" or "field.change.cancel" or "field.change.plan" or "field.change.status" or "field.recycleBin.list" or "field.settings.describe" or "file.list" or "formula.draft.validate" or "formula.preview" or "formula.validate" or "history.read" or "lookup.list" or "mutation.apply" or "mutation.preview" or "preset.list" or "preset.save" or "preset.delete" or "query.page" or "query.view" or "query.cursorOpen" or "query.cursorFetch" or "query.readRows" or "query.selectionOpen" or "query.validateSnapshot" or "schema.describe" or "schema.getTable" or "schema.list"
        ...
        foreach (string method in RelationLookupRpcRegistry.RequestTypes)
        {
            ...
            Assert.AreEqual(method is "relation.applyDelta" or "relation.createTarget" or "relation.updateSingle" or "relation.searchTargets" or "relation.previewDelta" or "lookup.query" or "lookup.valuePage"
    ...
    [TestMethod]
    public void FormulaMethodsSelectGoWithoutPythonFallback()
    {
        foreach (string method in new[] { "formula.validate", "formula.draft.validate", "formula.preview" })
        {
            ProductRpcCapabilityCatalog catalog = ProductDataRpcRegistry.TryGet(method, out var endpoint)
                ? endpoint.CapabilityCatalog
                : ProductRpcCapabilityCatalog.Product;
