...
public sealed class ProductRpcRouteSelectorTests
{
    ...
    public void GeneratedPolicySelectsCurrentOwners()
    {
        ...
        foreach (string method in ProductDataRpcRegistry.RequestTypes)
        {
            ...
            Assert.AreEqual(method is "events.reconcile" or "file.list" or "history.read" or "lookup.list" or "query.page" or "query.selectionOpen" or "schema.describe" or "schema.getTable" or "schema.list"
