...
<template>
  <header class="dashboard-toolbar">
    ...
    <div class="toolbar-actions">
      ...
      <NTooltip><template #trigger><NButton quaternary size="small" :aria-label="t('dashboard.action.refresh')" @click="emit('refresh')"><NIcon><RefreshCw /></NIcon></NButton></template>{{ t("dashboard.action.refresh") }}</NTooltip>
      <NButtonGroup v-if="editing">
        ...
        <NButton size="small" type="primary" :disabled="!dirty" :loading="saving" @click="emit('save')"><template #icon><NIcon><Check /></NIcon></template>{{ t("dashboard.action.save") }}</NButton>
      </NButtonGroup>
