...
20 项自有发现样本现已整理为[版本化语料入口](../../tests/contract/pdf_qualification_corpus.md)，冻结目标状态、token 与页面外文本排除项；七项合法样本重新通过独立 Poppler 语义核对。生成器成功并不等于产品资格通过。外部生产者、剩余资源/取消边界及产品状态映射仍待补齐，再决定是否接受 ADR。
