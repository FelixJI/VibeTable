...
PR275 冻结语料已由 PR273 覆盖合入。来源 PR280 在 a1bffd8 的完整 CI34158478173 已通过；本次按已授权整合流程，与独立通过 CI 的 PR278 一起整合，并同步包含 query.page 的 main 8cf989c5。PR 相对 main 仍为 readRows、cursorOpen、cursorFetch 三个读取方法；保留 main 的 history 生命周期、page 恢复和 S18 增量，生成清单为11 Go、89 Python、2 native。最终端点仍须独立双轴审查、fresh CI、squash及post-main CI/CD；来源绿色不替代这些门禁。
