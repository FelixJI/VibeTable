...
- Alternative views 已关闭 Gallery、Kanban 与 Calendar date 字段；Calendar datetime 与 Timeline 日期移动继续保持未验收，不从相邻 Calendar seam 推断通过。
