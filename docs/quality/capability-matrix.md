...
- Alternative views 已关闭 Gallery、Kanban 与 Calendar date 字段；Timeline point/date 已实现但仍等待 `main` 打包产品证据，不提前标记 Closed。Calendar datetime、Timeline datetime 与 range 继续保持未验收，不从相邻 date/point seam 推断通过。
