...
- 当前 manifest gap：6（`24-directory-replica-conflict`、`32-shared-work-calendar`、`33-host-grid-presentation`、`34-relation-lookup-data-io`、`35-data-io-interoperability`、`36-backend-import-exit`）。
...
当前 S28 保留原关系预览断言，并增加真实选择器多值增删、单值替换和清空、新建目标、Lookup 更新与同 UUID 重开。旧主干样本只证明预览语义，不能证明新增关系写入资格；本轮结果以 #345 对应 PR 的新包证据为准。
