...
var rpcMethods = map[CurrentOwner]map[string]struct{}{
	PythonBff:    set("command.list", "command.run", "data.applyImport", "data.export", "data.generateTemplate", "data.previewImport", "file.applyHostChange", "file.saveHostFile", "file.token", "formula.draft.validate", "formula.preview", "formula.validate", "gridState.get", "gridState.save", "path.registerExportTarget", "path.registerImportSource", "path.requestExportTarget", "path.requestImportSource", "path.resolveGrant", "plugin.cancelInstall", "plugin.cancelTask", "plugin.commitInstall", "plugin.describeAction", "plugin.getTask", "plugin.inspectInstall", "plugin.listAudit", "plugin.listCatalog", "plugin.listPendingCleanup", "plugin.resolveFile", "plugin.resolveInteraction", "plugin.rollback", "plugin.setEnabled", "plugin.startAction", "plugin.uninstall", "plugin.upgrade", "schema.delete", "schema.table.create", "shortcut.delete", "shortcut.launch", "shortcut.list", "shortcut.save", "system.handshake", "table.applyPaste", "table.previewPaste", "task.cancel", "task.create", "task.status", "version.compare", "version.create", "version.delete", "version.list", "version.promote", "version.save"),
	GoSidecar:    set("contentProfile.commit", "contentProfile.delete", "contentProfile.load", "events.reconcile", "field.settings.describe", "file.list", "history.applyRestore", "history.previewRestore", "history.read", "insights.dashboardQueryLimits", "insights.deleteDashboardWorkspace", "insights.executeDashboardQuery", "insights.listDashboards", "insights.panelManifest", "insights.readDashboardWorkspace", "insights.saveDashboardDraft", "interface.commit", "interface.delete", "interface.list", "interface.load", "lookup.list", "lookup.query", "lookup.valuePage", "mutation.apply", "mutation.preview", "preset.delete", "preset.list", "preset.save", "query.cursorFetch", "query.cursorOpen", "query.page", "query.readRows", "query.selectionOpen", "query.validateSnapshot", "query.view", "recordDocumentLink.commit", "recordDocumentLink.delete", "recordDocumentLink.list", "recordDocumentLink.repair", "relation.applyDelta", "relation.createTarget", "relation.inspectPair", "relation.previewDelta", "relation.searchTargets", "relation.updateSingle", "schema.describe", "schema.getTable", "schema.list", "settings.commitWorkCalendar", "settings.readWorkCalendar"),
	WpfHost:      set("settings.readDevice", "settings.saveDevice"),
	PythonWorker: set(),
}
