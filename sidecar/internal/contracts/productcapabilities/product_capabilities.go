...
var rpcMethods = map[CurrentOwner]map[string]struct{}{
	...
	GoSidecar:    set("events.reconcile", "file.list", "history.read", "lookup.list", "query.cursorFetch", "query.cursorOpen", "query.page", "query.readRows", "query.selectionOpen", "query.view", "relation.previewDelta", "schema.describe", "schema.getTable", "schema.list"),
