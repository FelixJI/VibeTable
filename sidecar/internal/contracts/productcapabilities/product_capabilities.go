...
var rpcMethods = map[CurrentOwner]map[string]struct{}{
	...
	GoSidecar:    set("events.reconcile", "field.settings.describe", "file.list", "history.read", "lookup.list", "lookup.query", "lookup.valuePage", "query.cursorFetch", "query.cursorOpen", "query.page", "query.readRows", "query.selectionOpen", "query.validateSnapshot", "query.view", "relation.inspectPair", "relation.previewDelta", "relation.searchTargets", "schema.describe", "schema.getTable", "schema.list"),
