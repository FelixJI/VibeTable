...
var rpcDescriptors = []RPCDescriptor{
	...
	{Method: "field.settings.describe", Scope: WorkspaceScope, Audience: RendererPublic, CapabilityID: "schema.query", Owner: PythonBff, Effect: ReadEffect},
