...
func generatedGoSidecarRegistrations() []Registration {
	...
	return []Registration{
		...
		{Method: "table.applyPaste", Scope: productcapabilities.WorkspaceScope, ValidateParams: validator, Handler: handler},
		{Method: "table.previewPaste", Scope: productcapabilities.WorkspaceScope, ValidateParams: validator, Handler: handler},
		{
		...
		{
			Method: "field.settings.describe", Scope: productcapabilities.WorkspaceScope,
			ValidateParams: validator, Handler: handler,
		},
		{
		...
		{
			Method: "formula.draft.validate", Scope: productcapabilities.WorkspaceScope,
			ValidateParams: validator, Handler: handler,
		},
		{
			Method: "formula.preview", Scope: productcapabilities.WorkspaceScope,
			ValidateParams: validator, Handler: handler,
		},
		{
			Method: "formula.validate", Scope: productcapabilities.WorkspaceScope,
			ValidateParams: validator, Handler: handler,
		},
		...
		{Method: "relation.applyDelta", Scope: productcapabilities.WorkspaceScope, ValidateParams: validator, Handler: handler},
		{Method: "relation.createTarget", Scope: productcapabilities.WorkspaceScope, ValidateParams: validator, Handler: handler},
		{Method: "relation.updateSingle", Scope: productcapabilities.WorkspaceScope, ValidateParams: validator, Handler: handler},
		{
