...
func presetProductMux(t *testing.T, pb *pocketbase.PocketBase, gates ...businessWriteGate) http.Handler {
	...
	dispatcher, err := productrpc.New(productrpc.Identity{
		...
		unrelatedPresetRegistration(t, "interface.commit"),
		unrelatedPresetRegistration(t, "interface.delete"),
		unrelatedPresetRegistration(t, "interface.list"),
		unrelatedPresetRegistration(t, "interface.load"),
		unrelatedPresetRegistration(t, "insights.dashboardQueryLimits"),
		unrelatedPresetRegistration(t, "insights.deleteDashboardWorkspace"),
		unrelatedPresetRegistration(t, "insights.executeDashboardQuery"),
		unrelatedPresetRegistration(t, "insights.listDashboards"),
		unrelatedPresetRegistration(t, "insights.panelManifest"),
		unrelatedPresetRegistration(t, "insights.readDashboardWorkspace"),
		unrelatedPresetRegistration(t, "insights.saveDashboardDraft"),
