...
func TestWorkspaceV2WriteBoundaryFailsClosed(t *testing.T) {
	tests := []struct {
		...
		{"import plan settle", http.MethodPost, "/api/vibetable/v2/import-plans/settle", true},
		{"import plan unknown adjacent path", http.MethodPost, "/api/vibetable/v2/import-plans/replay", false},
		{"import plan stage extra segment", http.MethodPost, "/api/vibetable/v2/import-plans/stage/extra", false},
		{"import plan trailing slash", http.MethodPost, "/api/vibetable/v2/import-plans/", false},
		...
		{"product interface upsert required", http.MethodPost, "/api/vibetable/v1/metadata/interfaces/upsert", false},
		{"product interface delete required", http.MethodPost, "/api/vibetable/v1/metadata/interfaces/delete", false},
