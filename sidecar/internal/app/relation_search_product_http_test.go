...
func relationSearchHTTPMux(t *testing.T, pb *pocketbase.PocketBase, registration productrpc.Registration) http.Handler {
	...
	dispatcher, err := productrpc.New(productrpc.Identity{WorkspaceID: "11111111-1111-4111-8111-111111111111", SessionEpoch: 7, FenceEpoch: 3, ClaimID: "aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa"},
		...
		registration, unrelatedRelationInspectRegistration(t),
		unrelatedRelationWriteRegistration(t, "relation.createTarget"),
		unrelatedRelationWriteRegistration(t, "relation.updateSingle"),
		unrelatedRelationWriteRegistration(t, "relation.applyDelta"), productrpc.ReconcileRegistration(catalog), queryValidateSnapshotRegistration(unrelatedQueryValidateSnapshotMustNotRun{t: t}),
