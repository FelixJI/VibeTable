...
func TestSidecarWorkspaceV2HTTPFailsClosedAndPersistsAcrossRestart(t *testing.T) {
	...
	if productCapabilities.ContractVersion != "2.0" ||
		...
		productCapabilities.RPCMethods[3] != "query.cursorFetch" ||
		productCapabilities.RPCMethods[4] != "query.cursorOpen" ||
		...
		productCapabilities.Registrations[3].Method != "query.cursorFetch" ||
		productCapabilities.Registrations[3].Scope != "workspace" ||
		productCapabilities.Registrations[4].Method != "query.cursorOpen" ||
