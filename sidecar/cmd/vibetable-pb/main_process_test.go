...
func TestSidecarWorkspaceV2HTTPFailsClosedAndPersistsAcrossRestart(t *testing.T) {
	...
	if productCapabilities.ContractVersion != "2.0" ||
		...
		len(productCapabilities.RPCMethods) != 16 ||
		...
		productCapabilities.RPCMethods[4] != "lookup.valuePage" ||
		productCapabilities.RPCMethods[5] != "query.cursorFetch" ||
		productCapabilities.RPCMethods[6] != "query.cursorOpen" ||
		productCapabilities.RPCMethods[7] != "query.page" ||
		productCapabilities.RPCMethods[8] != "query.readRows" ||
		productCapabilities.RPCMethods[9] != "query.selectionOpen" ||
		productCapabilities.RPCMethods[10] != "query.view" ||
		productCapabilities.RPCMethods[11] != "relation.previewDelta" ||
		productCapabilities.RPCMethods[12] != "relation.searchTargets" ||
		productCapabilities.RPCMethods[13] != "schema.describe" ||
		productCapabilities.RPCMethods[14] != "schema.getTable" ||
		productCapabilities.RPCMethods[15] != "schema.list" ||
		len(productCapabilities.Registrations) != 16 ||
		...
		productCapabilities.Registrations[4].Method != "lookup.valuePage" ||
		productCapabilities.Registrations[4].Scope != "workspace" ||
		productCapabilities.Registrations[5].Method != "query.cursorFetch" ||
		productCapabilities.Registrations[5].Scope != "workspace" ||
		productCapabilities.Registrations[6].Method != "query.cursorOpen" ||
		productCapabilities.Registrations[6].Scope != "workspace" ||
		productCapabilities.Registrations[7].Method != "query.page" ||
		productCapabilities.Registrations[7].Scope != "workspace" ||
		productCapabilities.Registrations[8].Method != "query.readRows" ||
		productCapabilities.Registrations[8].Scope != "workspace" ||
		productCapabilities.Registrations[9].Method != "query.selectionOpen" ||
		productCapabilities.Registrations[9].Scope != "workspace" ||
		productCapabilities.Registrations[10].Method != "query.view" ||
		productCapabilities.Registrations[10].Scope != "workspace" ||
		productCapabilities.Registrations[11].Method != "relation.previewDelta" ||
		productCapabilities.Registrations[11].Scope != "workspace" ||
		productCapabilities.Registrations[12].Method != "relation.searchTargets" ||
		productCapabilities.Registrations[12].Scope != "workspace" ||
		productCapabilities.Registrations[13].Method != "schema.describe" ||
		productCapabilities.Registrations[13].Scope != "workspace" ||
		productCapabilities.Registrations[14].Method != "schema.getTable" ||
		productCapabilities.Registrations[14].Scope != "workspace" ||
		productCapabilities.Registrations[15].Method != "schema.list" ||
