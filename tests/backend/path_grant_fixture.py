"""Test-only grant fixture for format and import-plan tests.

Production authority lives in HostSessionFileBroker. This retained in-memory
fixture supplies deterministic grants to Python format tests; it is neither a
production fallback nor evidence for native Host ownership.
"""
