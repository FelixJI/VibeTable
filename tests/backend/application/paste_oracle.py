"""Frozen pre-migration Python paste oracle, unavailable to production composition.
...
from backend.application.paste_service import PasteError, PasteMutationPort
